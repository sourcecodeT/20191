...
Type *compileLValue(void) {
  // TODO sementics-4: parse a lvalue (a variable, an array element, a
  // parameter the current function identifier)
  Object *var;
...
void compileForSt(void) {
  // TODO sementics-4: Check type consistency of FOR's variable
  eat(KW_FOR);
  eat(TK_IDENT);
...
void compileArgument(Object *param) {
  // TODO semantics-4: parse an argument, and check type consistency
...
void compileArguments(ObjectNode *paramList) {
  // TODO semantics-4: parse a list of arguments, check the consistency of the
  // arguments and the given parameters
  switch (lookAhead->tokenType) {
    case SB_LPAR:
      if (paramList == NULL) {
...
void compileCondition(void) {
  // TODO semantics-4: check the type consistency of LHS and RSH, check the
  // basic type
  Type *type1 = compileExpression();
...
Type *compileFactor(void) {
  // TODO semantics-4: parse a factor and return the factor's type
...
Type *compileIndexes(Type *arrayType) {
  // TODO semantics-4: parse a sequence of indexes, check the consistency to the
  // arrayType, and return the element type
